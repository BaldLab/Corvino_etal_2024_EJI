...
dev.copy(pdf, paste0(output.dir, "Pancancer_Nebulosa_UCell_scores_top10_downsampled.pdf"))
dev.off()
...
### Deeper analysis of Esophagus dataset
```{r ISG_high_tumors}
...
if(long.compute){
  ...
  tissue.vec <- c("Esophagus")
  
  Esophagus.seurat <- subset(pancancer.cd8, idents = tissue.vec)
  
  # take just cells from tumor tissue
  Idents(Esophagus.seurat) <- Esophagus.seurat@meta.data$Type
  
  Esophagus.seurat <- subset(Esophagus.seurat, idents = "Tumor")
  
  # check subsetting correctly performed 
  table(Esophagus.seurat@meta.data$Tissue, Esophagus.seurat@meta.data$Type)

  
  # store upper level seurat clusters incase needed later
  Esophagus.seurat$orig.clusters <- Esophagus.seurat@meta.data$seurat_clusters
  ...
  Plot_Density_Custom(Esophagus.seurat, 
                      features =  "Top_10_UCell",
                      custom_palette = batlow.pal,
                      joint = FALSE, 
                      pt.size = 1, 
  ...
  # Rename clusters
Esophagus.seurat@meta.data$IFN_clusters <- Esophagus.seurat@meta.data$seurat_clusters

Idents(Esophagus.seurat) <- Esophagus.seurat@meta.data$IFN_clusters
Esophagus.seurat <- Esophagus.seurat %>%
  RenameIdents('0' = "ISG_1",
               '1' = "other",
               '2' = "other", 
               '3' = "other",
               '4' = "other", 
               ...
               '12' = "other",
               '13' = "other")
Idents(Esophagus.seurat)

Esophagus.seurat@meta.data$IFN_status <- Idents(Esophagus.seurat)
...
x <- table(Esophagus.seurat@meta.data$IFN_status, Esophagus.seurat@meta.data$cloneType)
