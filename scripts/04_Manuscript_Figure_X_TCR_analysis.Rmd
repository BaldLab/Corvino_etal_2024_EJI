...
colnames(clonotype.data)[4]

ISG.clones <- clonotype.data[,4]
ISG.clones <- sort(ISG.clones, decreasing = T)
names(ISG.clones[1:20])
x <- ISG.clones[ISG.clones>5]
length(x)

Idents(CD8.seurat.tcr) <- CD8.seurat.tcr@meta.data$CTaa

temp.seurat <- subset(CD8.seurat.tcr, idents = c(names(x)))
