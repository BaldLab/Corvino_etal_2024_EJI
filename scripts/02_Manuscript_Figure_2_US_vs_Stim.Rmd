...
label.var <- c("IL2", "IL7R", "XCL1", 
               "TNF", "CD69", "GZMK", "IFNG",
               "CD28", "TCF7", "CD226", "TOX",
               "NKG7", "CTLA4", "GZMA", "PRF1", 
               "ENTPD1", "TIGIT", "GZMB", "LAG3", 
               "HAVCR2", "GNLY")
...
dev.off()
 ...
 #library("scico")
  #  col_fun <- scico::scale_fill_scico(palette = "batlow", 
   #                                    direction = 1, 
    #                                   na.value = "white")
...
scRepertoire::clonalOverlay(CD8.seurat.tcr.filt, reduction = "umap", facet = "Clusters_l1")
...
tcr.clusters <- expression2List.mod(CD8.seurat.tcr.filt, group = "Clusters_l1")
