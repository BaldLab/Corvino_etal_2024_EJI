...
# For filtered result
Stim_filt <- extract_list_clonotypes (seurat_object = CD8.seurat.tcr_filt, overlap_var = "Stim")
US_filt <- extract_list_clonotypes (seurat_object = CD8.seurat.tcr_filt, overlap_var = "US")
...
venn_filt <- venn.diagram(
        ...
        category.names = c("US", "Stim" ),
        filename = paste0(output.dir,"venn_condition_CTaa_overlap_filt.tiff"),
        output=F,
