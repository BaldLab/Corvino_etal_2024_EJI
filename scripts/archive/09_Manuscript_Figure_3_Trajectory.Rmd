...
scv.tl.recover_dynamics(sc_untreated, n_jobs = 12) 
...
scv.tl.velocity_graph(sc_untreated, n_jobs = 12)
...
trainer = dv.train(sc_untreated, dv.Constants.default_configs)
...
# save data
sc_untreated.write('saves/sc_untreated_velocity_deepvelo.h5ad')
...
scv.pl.velocity_embedding(sc_untreated, 
arrow_length = 3, 
arrow_size = 2,
dpi = 300,
...
scv.pl.velocity(sc_untreated, ['NKG7',  'GZMA', 'CD226', 'TOX'], ncols=2)



scv.pl.velocity(sc_untreated, ['ENSG00000126709.16'], ncols=1,save="scvelo_gene_dynamics.png")
