...
output.dir <- "results/scRNAseq/tables/DEG_Clusters/"
...
# Write data to file
write.csv(Cluster.markers.pos, paste0(output.dir, "Cluster_markers_unfiltered_pos.csv"))

# Filter by sig Padj val
sum(Cluster.markers.pos$p_val_adj < 0.05) # 2,919 genes 

write.csv(Cluster.markers.pos[Cluster.markers.pos$p_val_adj < 0.05, ],
          paste0(output.dir, "Cluster_markers_sig_only_pos.csv"))
...
# Write data to file
write.csv(Cluster.markers, paste0(output.dir, "Cluster_markers_unfiltered.csv"))

# Filter by sig Padj val
sum(Cluster.markers$p_val_adj < 0.05) # 4,890 genes 

write.csv(Cluster.markers[Cluster.markers$p_val_adj < 0.05, ],
          paste0(output.dir, "Cluster_markers_sig_only.csv"))
...
for(i in 1:length(Cluster.vect)){
  ...
  write.csv(x, paste0(output.dir, "Top_40_markers_for_cluster_", Cluster.vect[i], ".csv"))
...
# Create output directory
fig.dir <- "results/scRNAseq/figures/DEG_Clusters_btn_conditions/"
...
table.dir <- "results/scRNAseq/tables/DEG_Clusters_btn_conditions/"
...
clust.var <- seurat.combined@meta.data$Clusters_l1
...
for(i in 1:length(clust.var)){
  ...
  # Write data to file
  write.csv(DEG.var, paste0(table.dir, "Stim_vs_US_DEG_clust_", clust.var[i], ".csv"))
  ...
  write.csv(x, paste0(table.dir, "Top_40_markers_for_Stim_vs_US_cluster_", clust.var[i], ".csv"))
...
for(i in 1:length(clust.var)){
  ...
  print(plot(p1))
  dev.copy(pdf, paste0(fig.dir, "ScatterPlot_Stim_vs_US_cluster_", clust.var[i], "_all_Sig_genes.pdf"))
  dev.off()
...
# Create output directory
output.dir <- "results/scRNAseq/figures/DEG_Clusters_btn_conditions/visualising_gene_expression/"
...
#cluster.markers.df <- read.csv("results/scRNAseq/tables/DEG_Clusters/Cluster_markers_unfiltered.csv")
...
for(i in seq_along(goi)){
  ...
  dev.copy(pdf, paste0(output.dir, "VlnPlot_", goi[i], ".pdf"))
  dev.off()
}
...
if(long.compute){
  ...
  source("scripts/functions/SingleCellHaystack_function.R", local = knitr::knit_global())
  
  scHay(seurat.combined, 
        output.dir = "results/scRNAseq/figures/singleCellHaystack/")
  
  
  # Note the function needs to be modified to export a more usable table, currently its unclear how to search the table produced by
  # haystack function for the top DEGs
...
# Create output directory
heatmap.dir <- "results/scRNAseq/figures/Cluster_DEG_Heatmaps/"

if(!dir.exists(paste0(heatmap.dir))){
  dir.create(paste0(heatmap.dir), 
             recursive = T)
}

dotplot.dir <- "results/scRNAseq/figures/Cluster_DEG_dotplots/"
...
Cluster.vect <- unique(seurat.combined.small@meta.data$Clusters_l1)
...
for(i in 1:length(Cluster.vect)){
  ...
  dev.copy(pdf, paste0(heatmap.dir, "Heatmap_topDEGs_clust_", Cluster.vect[i], ".pdf"))
  dev.off()
  ...
  dev.copy(pdf, paste0(heatmap.dir, "Heatmap_topDEGs_clust_", Cluster.vect[i], "_average.pdf"))
  dev.off()
  ...
  dev.copy(pdf, paste0(dotplot.dir, "DotPlot_TopDEGs_clust_", Cluster.vect[i], ".pdf"))
  dev.off()
...
# Create output directory
output.dir <- "results/scRNAseq/figures/Large_Summary_heatmaps/"
...
dev.copy(pdf, paste0(output.dir, "Heatmap_top_up_genes_bycluster_Averaged.pdf"))
dev.off()
...
dev.copy(pdf, paste0(output.dir, "Heatmap_top_up_genes_bycluster.pdf"))
dev.off()
...
Cluster.markers <- read.csv("results/scRNAseq/tables/DEG_Clusters/Cluster_markers_sig_only.csv")
...
pdf(paste0(output.dir, "Heatmap_top_up_genes_bycluster_highlighted_geneIDs_averaged.pdf"))
...
pdf(paste0(output.dir, "Heatmap_top_up_genes_bycluster_highlighted_geneIDs.pdf"))
...
# Create output directory
feature.dir <- "results/scRNAseq/figures/Top_DEG_plots/FeaturePlots/"

if(!dir.exists(paste0(feature.dir))){
  dir.create(paste0(feature.dir), 
             recursive = T)
}

vln.dir <- "results/scRNAseq/figures/Top_DEG_plots/VlnPlots/"

if(!dir.exists(paste0(vln.dir))){
  dir.create(paste0(vln.dir), 
             recursive = T)
}
...
x <- read.csv("results/scRNAseq/tables/DEG_Clusters/Cluster_markers_sig_only.csv")
...
for(i in 1:length(Top.cluster.genes)){
  ...
  dev.copy(pdf, paste0(vln.dir, "VlnPlot_", Top.cluster.genes[i], ".pdf"))
  dev.off()
  ...
  dev.copy(pdf, paste0(feature.dir, "FeaturePlot_", Top.cluster.genes[i], ".pdf"))
  dev.off()
...
# Create output directory
feature.dir <- "results/scRNAseq/figures/Top_DEG_plots_Imputed/FeaturePlots/"
...
vln.dir <- "results/scRNAseq/figures/Top_DEG_plots_Imputed/VlnPlots/"
...
for(i in 1:length(Top.cluster.genes)){
  ...
  dev.copy(pdf, paste0(vln.dir, "VlnPlot_", Top.cluster.genes[i], "_imputed.pdf"))
  dev.off()
  ...
  dev.copy(pdf, paste0(feature.dir, "FeaturePlot_", Top.cluster.genes[i], "_imputed.pdf"))
  dev.off()
...
# Create output directory
output.dir <- "results/scRNAseq/figures/VolcanoPlots/FeaturePlots/"
...
source("scripts/functions/Enhanced_volcano_custom_defaults_function.R")
...
for(i in 1:length(cluster.var)){
  ...
  dev.copy(pdf, paste0(output.dir, "Volcano_", cluster.var[i], ".pdf"))
  dev.off()
