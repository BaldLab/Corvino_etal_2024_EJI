...
write.csv(paste0("Cluster_",CD8.seurat@meta.data$seurat_clusters), file = paste0(output.dir, "clusters.csv"))
...
write.csv(paste0("Cluster_",Stim.CD8.seurat@meta.data$seurat_clusters), file = paste0(output.dir, "clusters.csv"))
