...
scv.tl.recover_dynamics(sc_untreated) # required for dynamical modeling (not for deterministic)
...
```{python}
# save velocity data
sc_untreated.write('saves/sc_untreated_velocity.h5ad')
...
```{python}
scv.pl.velocity_embedding_stream(sc_untreated, 
basis = 'umap',
color = "clusters",
legend_fontsize = 6,
min_mass = 3, 
...
scv.pl.velocity_embedding_grid(sc_untreated,
basis = 'umap', 
color = "clusters",
legend_fontsize = 6,
min_mass = 3, 
