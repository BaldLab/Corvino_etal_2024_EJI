...
GEX2 = anndata.read('data/velocity/preprocessing_velocity/kb_count/GEX2/adata.h5ad')
```
...
scv.pl.proportions(sc_untreated,save="results/Manuscript/Figure3/US/scvelo_prop.png")
...
```{python}
# save velocity data
sc_untreated.write('saves/velocity/sc_untreated_velocity.h5ad')
