---
title: "Analysis script - velocity - Bald group"
description: | 
...
```{r}
seurat_combined <- readRDS("/work_dir/data/seurat_combined.rds")
DimPlot(seurat_combined,reduction = "umap") +
  ggtitle("Full dataset")

idents_to_use <- as.character(unique(Idents(seurat_combined)))
idents_to_use <- setdiff(idents_to_use,c("MAIT","TRM","gd_T_non_g9d2","gd_T_g9d2"))

# combined dataset
seurat_combined_reduced <- subset(seurat_combined,idents = idents_to_use)
DimPlot(seurat_combined_reduced,reduction = "umap")+
  ggtitle("Full dataset filtered")

# untreated dataset
seurat_combined_reduced_ctrl <- subset(seurat_combined_reduced,subset = group %in% c("S1","S2"))
DimPlot(seurat_combined_reduced_ctrl,reduction = "umap") +
  ggtitle("untreated cells")

# treated dataset
seurat_combined_reduced_stim <- subset(seurat_combined_reduced,subset = group %in% c("S3","S4"))
DimPlot(seurat_combined_reduced_stim,reduction = "umap") +
...
```{r}
# combined dataset
dir.create("/work_dir/results/exports/seurat_combined/")
write.csv(Cells(seurat_combined_reduced), 
          file = "/work_dir/results/exports/seurat_combined/cellID_obs.csv", row.names = FALSE)

write.csv(Embeddings(seurat_combined_reduced, reduction = "umap"), file = "/work_dir/results/exports/seurat_combined/cell_embeddings.csv")

write.csv(paste0("Cluster_",seurat_combined_reduced@meta.data$seurat_clusters), file = "/work_dir/results/exports/seurat_combined/clusters.csv")


# untreated
dir.create("/work_dir/results/exports/seurat_untreated/")
write.csv(Cells(seurat_combined_reduced_ctrl), 
          file = "/work_dir/results/exports/seurat_untreated/cellID_obs.csv", row.names = FALSE)

write.csv(Embeddings(seurat_combined_reduced_ctrl, reduction = "umap"), file = "/work_dir/results/exports/seurat_untreated/cell_embeddings.csv")

write.csv(paste0("Cluster_",seurat_combined_reduced_ctrl@meta.data$seurat_clusters), file = "/work_dir/results/exports/seurat_untreated/clusters.csv")



# stimulated
dir.create("/work_dir/results/exports/seurat_treated/")
write.csv(Cells(seurat_combined_reduced_stim), 
          file = "/work_dir/results/exports/seurat_treated/cellID_obs.csv", row.names = FALSE)

write.csv(Embeddings(seurat_combined_reduced_stim, reduction = "umap"), file = "/work_dir/results/exports/seurat_treated/cell_embeddings.csv")

write.csv(paste0("Cluster_",seurat_combined_reduced_stim@meta.data$seurat_clusters), file = "/work_dir/results/exports/seurat_treated/clusters.csv")
...
# Run scVelo - untreated dataset
```{python}
sc.settings.figdir = '/work_dir/results/figures/untreated/'
scv.settings.figdir = '/work_dir/results/figures/untreated/'
cr.settings.figdir = '/work_dir/results/figures/untreated/'
...
```{python}
scv.pl.proportions(GEX1,save="/work_dir/results/figures/untreated/scvelo_prop_gex1.png")
scv.pl.proportions(GEX2,save="/work_dir/results/figures/untreated/scvelo_prop_gex2.png")
...
scv.pl.proportions(sc_untreated,save="/work_dir/results/figures/untreated/scvelo_prop.png")
...
ggsave(plot = p1,width = 10,height = 6,filename = "/work_dir/results/figures/untreated/umap_scvelo_clusters.png")
p1
...
ggsave(plot = p2,width = 10,height = 6,filename = "/work_dir/results/figures/untreated/umap_scvelo_samples.png")
p2
...
ggsave(plot = p3,width = 10,height = 6,filename = "/work_dir/results/figures/untreated/clusters.png")
p3
...
ggsave(plot = p4,width = 10,height = 6,filename = "/work_dir/results/figures/untreated/clusters_perc.png")
p4
...
```{python}
# save velocity data
sc_untreated.write('/work_dir/results/exports/seurat_untreated/sc_untreated_velocity.h5ad')
#sc_untreated = anndata.read('/work_dir/results/exports/seurat_untreated/sc_untreated_velocity.h5ad')
...
scv.pl.velocity_embedding_stream(sc_untreated, basis = 'umap',color="clusters",
legend_fontsize=6,save="sc_velo_umap_velocity2.png")
...
scv.pl.velocity(sc_untreated, ['ENSG00000126709.16'], ncols=2,save="/work_dir/results/figures/untreated/scvelo_gene_dynamics.png")
...
# Run scVelo - treated dataset
```{python}
sc.settings.figdir = '/work_dir/results/figures/treated/'
scv.settings.figdir = '/work_dir/results/figures/treated/'
cr.settings.figdir = '/work_dir/results/figures/treated/'
scv.settings.set_figure_params('scvelo') 
cr.settings.set_figure_params('scvelo') 
...
```{python}
sc.settings.figdir = '/work_dir/results/figures/combined/'
scv.settings.figdir = '/work_dir/results/figures/combined/'
cr.settings.figdir = '/work_dir/results/figures/combined/'
scv.settings.set_figure_params('scvelo') 
cr.settings.set_figure_params('scvelo') 
