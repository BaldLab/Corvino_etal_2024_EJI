...
Results: Our analysis identified a subset of CD8+ TILs highly enriched for interferon-stimulated genes (ISG). Trajectory inference suggested ISG cells transition via granzyme K (GZMK)-expressing cells towards terminal effector states. However, unlike GZMK cells, which exhibited rapid effector-like phenotypes following stimulation, ISG cells were transcriptionally inert. Additionally, ISG cells showed specific enrichment within tumor and were found across multiple tumor entities.
