cytoTRACE.mod <- function(cyto_obj = NULL, phenotype = NULL, gene = NULL, colors = NULL, emb = NULL, otherName = NULL, otherValue = NULL, outputDir = "./"){
  ...
  if(!is.null(otherValue)){
    ...
    if(length(gene_exp) != length(cyto)){stop("The length of the 'otherValue' object does not match the length of the CytoTRACE object.", type = "error")}
  }
