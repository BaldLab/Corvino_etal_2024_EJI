...
############################################################################################################################
# Nick analysis method

# Get metadata from seurat object - ignoring already added TCR info 
meta.data <- seurat.combined[[]]
meta.data <- meta.data[,which(colnames(meta.data) == "group"):ncol(meta.data)]


source("~/Documents/GitHub/My_repos/HNSCC_Descriptive/R/combineMeta.R")
...
# Source function
source("~/Documents/GitHub/My_repos/HNSCC_Descriptive/R/getCircles.R")
...
```{r}
dir.create("output/figures/ChordVisualizations")
dir <- "output/figures/ChordVisualizations"
...
#getCircles
    ...
    pdf(paste0(dir, "_Stimulated_TCRcircos_filt.pdf"), height=10, width=10)
...
pdf(paste0(dir, "_Untimulated_TCRcircos_filt.pdf"), height=10, width=10)
