...
# Create condition plus Stim status variable
...
seurat.tcr.filt@meta.data$Exhausted_Stim_potential_condition <- paste0(seurat.tcr.filt@meta.data$Exhausted_Stim_potential,
                                                                   "_",
                                                                   seurat.tcr.filt@meta.data$condition)
...
# Create condition plus stim status variable 
temp.seurat@meta.data$Exhausted_Stim_potential_condition <- paste0(temp.seurat@meta.data$Exhausted_Stim_potential,
                                                                   "_",
                                                                   temp.seurat@meta.data$condition)

temp.seurat@meta.data$Exhausted_Stim_potential_condition <- factor(temp.seurat@meta.data$Exhausted_Stim_potential_condition, 
                                                                   levels = c("Unstimable_US", "Unstimable_Stim", "Stimable_US", "Stimable_Stim"))
