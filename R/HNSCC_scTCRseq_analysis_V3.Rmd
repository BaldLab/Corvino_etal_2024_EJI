...
meta.tcr <- seurat.tcr.filt@meta.data
...
temp.seurat.small <- subset(temp.seurat.small, idents = c("Unstimable_US", "Stimable_US"))
...
print(VlnPlot(temp.seurat, goi[i]), pt.size = 0.4)
}
