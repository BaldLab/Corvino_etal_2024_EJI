...
working.dir <- gsub("/R", "", working.dir)
setwd(working.dir)
...
####Ploting
pdf("TwoVariables_test_Circos2.pdf", height=10, width=10)
...
for(species in unique(combined$from)) {
    ...
    highlight.sector(sn, track.index = 1, col = color_species[species], niceFacing = TRUE)
}
