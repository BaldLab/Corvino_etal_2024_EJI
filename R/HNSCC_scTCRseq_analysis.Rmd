...
temp <- table(Query.clonotypes$CTaa, Query.clonotypes$seurat_clusters)
# Format table
...
seurat.tcr <- highlightClonotypes(seurat.tcr, 
                              cloneCall= "aa", 
                              sequence = stimulatable.clones)

seurat.tcr@meta.data$highlight[!is.na(seurat.tcr@meta.data$highlight)] <- "Selected"
seurat.tcr@meta.data$highlight[is.na(seurat.tcr@meta.data$highlight)] <- "NA"
...
plot_density(seurat.combined, "GZMA")
