...
stimulatable.clones <- rownames(clonotype.freq)[clonotype.freq[,1] >= 30]
unstimulatable.clones <- rownames(clonotype.freq)[clonotype.freq[,1] <= 10]

length(unique(stimulatable.clones))
length(unique(unstimulatable.clones))
...
write.csv(Stim.potential.markers, "DEG_restimability.csv")
